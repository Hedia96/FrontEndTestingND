   ...
   /* for(int i=0;i<invlines.size();i++)
    {
        ...
        //frame.getTable_invoices().setRowSelectionInterval(index_invselected, index_invselected);
         int index_lselected= frame.getTable_Invoice_lines().getSelectedRow();
          System.out.println(" selectlinr  " +index_lselected);
            
        }/*
        index_invselected=0;
      int index_lselected= frame.getTable_Invoice_lines().getSelectedRow();
        if(index_lselected!=-1){
             System.out.println("********** in value ************************");
            System.out.println("Selected line now is "+invlines.get(index_lselected));
        }*/
